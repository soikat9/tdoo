...
#        return used_ports
    ...
    def run_tele(self,name, db):
        ...
        try:
            ...
            self.dclient.containers.run(image=self.tele_image,name=name,detach=True,volumes={extra_path:{'bind':self.data_dir,"mode":"rw"}, path: {'bind': "/etc/tele/", 'mode': 'rw'},self.common_applets:{'bind': "/mnt/extra-applets", 'mode': 'rw'}},ports={9000:port, 9001 : lport },tty=True,restart_policy={"Name":"unless-stopped"}) #Start the container
