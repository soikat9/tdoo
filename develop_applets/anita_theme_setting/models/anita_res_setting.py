...
class AnitaUserSetting(models.TransientModel):
    ...
    def get_theme_values(self):
        ...
        control_panel_mode = config.get_param(key="anita_theme_setting.control_panel_mode", default='normal')
        ...
        window_default_title = config.get_param(key="anita_theme_setting.allow_debug", default="Awesome tele")
        powered_by = config.get_param(key="anita_theme_setting.powered_by", default="Awesome tele")
