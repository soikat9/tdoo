...
class EventWorkContext(WorkContext):
    ...
    :class:`tele.applets.component.core.WorkContext` or your own
    subclass.
    ...
    a :class:`tele.applets.component.core.WorkContext` with collection.
    ...
    def work_on(self, model_name=None, collection=None):
        ...
        if collection is not None:
            if self.env is not collection.env:
                raise ValueError(
                    "the Tele env of the collection must be "
