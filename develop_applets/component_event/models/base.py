...
Extend the 'base' Tele Model to add Events related features.
...
from tele.applets.component.core import _component_databases
    ...
    * ``on_record_unlink(self, record)``
    ...
    def _event(self, name, collection=None, components_registry=None):
        ...
        :type components_registry:
            :class:`tele.applets.components.core.ComponentRegistry`
        ...
        if not comp_registry or not comp_registry.ready:
            ...
            # This is a very special case, when the tele registry is being
            # built, it calls tele.modules.loading.load_modules().
