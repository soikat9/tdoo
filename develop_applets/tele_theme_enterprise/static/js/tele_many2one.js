tele.define('tele_theme_enterprise.many2one', function (require) {
    "use strict";
    ...
    relational_fields.FieldMany2One.include({
        ...
        _onInputClick: function () {
            if (this.$input.autocomplete("widget").is(":visible")) {
                ...
                this.$(".o_dropdown_arrow").addClass("tele_reverse")
            } else if (this.floating) {
                this.$(".o_dropdown_arrow").removeClass("tele_reverse")
        ...
        _bindAutoComplete: function () {
            ...
            this.$input.autocomplete({
                ...
                close: function (event) {
                    // add reverse here
                    self.$(".o_dropdown_arrow").addClass("tele_reverse")
