/** @tele-module alias=tele_theme_enterprise.appp_board **/
...
export class AppBoard extends Component {
    ...
    patched() {
        if (this.state.focusedIndex !== null && !this.env.isSmall) {
            const selectedItem = document.querySelector(".tele_app_board .o_menuitem.o_focused");
...
AppBoard.template = "tele_theme_enterprise.app_board";
