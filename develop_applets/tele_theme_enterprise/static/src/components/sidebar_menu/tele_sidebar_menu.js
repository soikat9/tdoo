...
import { SideBarAppItem } from "./tele_sidebar_app_item";
import { AppTabPane } from "./tele_sidebar_tab_pane";
...
export class SideBarMenu extends Component {
    ...
    setup() {
        ...
        this.appboardService = useService("tele_app_board");
    ...
    _isBoardVisible() {
        let $app_board = $(document.querySelector('.tele_app_board'))
...
SideBarMenu.props = {};
SideBarMenu.template = 'tele_theme_enterprise.sidebar_menu';
