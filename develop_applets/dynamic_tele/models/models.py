from tele.models import BaseModel, AbstractModel
...
def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
    ...
    if 'studio.view.center' in self.env.registry.models and res and action_id:
        ...
        elif 'view_id' not in res and view_ref and view_ref.find("tele_studio") >= 0:
            domain = [['view_key', '=', view_ref.replace("tele_studio.", "")]]
