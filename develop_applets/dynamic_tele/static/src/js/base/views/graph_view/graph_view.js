/** @tele-module alias=dynamic_tele.GraphView **/
...
utils.patch(GraphModel.prototype, 'dynamic_tele.GraphView.model', {
    setup(params) {
...
utils.patch(GraphView.prototype, 'dynamic_tele.GraphView.view', {
    setup() {
