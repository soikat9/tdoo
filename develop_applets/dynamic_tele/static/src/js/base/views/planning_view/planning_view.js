tele.define('dynamic_tele.PlanningView', function (require) {
"use strict";
...
var PlanningModel = require('dynamic_tele.PlanningModel');
var PlanningController = require('dynamic_tele.PlanningController');
var PlanningRenderer = require('dynamic_tele.PlanningRenderer');
