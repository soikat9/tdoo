tele.define('dynamic_tele.basic_widgets', function (require) {
    "use strict";
    ...
    var basicFields = require("dynamic_tele.basic_fields");
    ...
    var ChooseColor = base.WidgetBase.extend({
        ...
        initParams: function () {
            this.colors = ["#f44336", "#e91e63", "#2073c5", "#424869", "#673ab7", "#3f51b5", "#2196f3", "#03a9f4", "#00bcd4",
        ...
        init: function (parent, params) {
            ...
            this.info = {
                empty: {
                    ...
                    img: "/dynamic_tele/static/src/img/ic_todo_empty.png"
                },
    ...
    var ChangeImage = base.WidgetBase.extend({
        ...
        onChangeImage: function (e) {
            e.stopPropagation();
            e.stopImmediatePropagation();
            const {onChange} = this.props, MediaDialog = tele.__DEBUG__.services['wysiwyg.widgets.MediaDialog'],
                $image = $('<img/>');
