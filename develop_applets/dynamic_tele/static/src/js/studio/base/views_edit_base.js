tele.define('dynamic_tele.views_edit_base', function (require) {
    "use strict";
    ...
    const basic_fields = require('dynamic_tele.basic_fields');
    const basic_widgets = require('dynamic_tele.basic_widgets');
    const fieldRegistry = require('web.field_registry');
    const base = require("dynamic_tele.base");
    const {View} = require("@web/views/view");
    const ViewContainer = require("dynamic_tele.ViewContainer");
    ...
    var ViewContent = EditContent.extend({
        ...
        _prepareDataSave: function () {
            ...
            if (!res.view_id) {
                ...
                _context[res.view_type + '_view_ref'] = 'tele_studio.' + res.view_key;
        ...
        onChangeImage: function (e) {
            ...
            const MediaDialog = tele.__DEBUG__.services['wysiwyg.widgets.MediaDialog'], $image = $('<img/>');
