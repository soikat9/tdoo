tele.define('dynamic_tele.ReportEdit', function (require) {
    "use strict";

    var core = require('web.core');
    var Widget = require('web.Widget');
    var utils = require('web.utils');
    var baseEdit = require('dynamic_tele.views_edit_base');
    // var ReportKanBan = require('dynamic_tele.ReportKanBan');
    var Domain = require('web.Domain');
    var base = require("dynamic_tele.base");
    var basic_fields = require('dynamic_tele.basic_fields');
    var basic_widgets = require('dynamic_tele.basic_widgets');
    ...
    var ReportView = base.WidgetBase.extend({
        ...
        onClickPrint: async function () {
            const {reportParams} = this.props, reportUrl = this._makeReportUrls(reportParams), env = tele['studio'].env;
    ...
    var ReportProps = baseEdit.ViewProps.extend({
        ...
        prepareWidgetOptions: function (node, nodeProps) {
            const widgetOptions = tele.studio.fieldWidgetOptions, optionsValues = this._getOptionsValue() || {};
        ...
        getDataValues: function (el) {
            ...
            Object.keys(rawFields).map((fieldName) => {
                var field = {name: fieldName, string: fieldName}, fieldType = rawFields[fieldName],
                    fieldLabel = fieldType, model = tele.studio.models[fieldType];
                if (model) {
