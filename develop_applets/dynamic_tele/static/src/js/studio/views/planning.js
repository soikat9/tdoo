tele.define('dynamic_tele.planning', function (require) {
    "use strict";

    var Domain = require('web.Domain');
    var PlanningView = require('dynamic_tele.PlanningView');
    var PlanningController = require('dynamic_tele.PlanningController');
