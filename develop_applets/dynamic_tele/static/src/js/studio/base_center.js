tele.define('dynamic_tele.BaseCenter', function (require) {
    "use strict";

    var core = require('web.core');
    var base = require('dynamic_tele.base');
    var Calendar = require("dynamic_tele.calendar");
    var Pivot = require("dynamic_tele.pivot");
    // var Pivot = require("dynamic_tele.planning");
    // var Graph = require("dynamic_tele.planning");
    var Graph = require("dynamic_tele.graph");
    var KanBan = require("dynamic_tele.kanban");
    var Planning = require("dynamic_tele.planning");
    // var Activity = require("dynamic_tele.planning");
    var Activity = require("dynamic_tele.activity");
    var Form = require("dynamic_tele.form");
    var Search = require("dynamic_tele.search");
    var Tree = require("dynamic_tele.tree");
    var BasicModel = require('web.BasicModel');
    var BasicView = require('web.BasicView');
    var session = require('web.session');
    // var ActionManager = require('web.ActionManager');
    var AppCenter = require("dynamic_tele.AppCenter");
    ...
    var BaseChooseView = base.WidgetBase.extend({
        ...
        init: function (parent, params) {
            ...
            this.views.battery = {
                ...
                img: "/dynamic_tele/static/src/img/buttery_png.png",
                icon: ""
            };
            this.views.title = {
                label: "Title",
                ...
                img: "/dynamic_tele/static/src/img/number_png.png",
                icon: ""
            };
            this.views.todo = {
                label: "Todo List",
                ...
                img: "/dynamic_tele/static/src/img/todo_list_png.png",
                icon: ""
            };
            this.views.pivot = {
                label: "Pivot",
                ...
                img: "/dynamic_tele/static/src/img/pivot_png.png",
                icon: "fa fa-table"
            };
            this.views.activity = {
                label: "Activity",
                ...
                img: "/dynamic_tele/static/src/img/activity_png.png",
                icon: "fa fa-th"
            };
            this.views.graph = {
                label: "Chart",
                ...
                img: "/dynamic_tele/static/src/img/chart_png.png",
            ...
            this.views.kanban = {
                ...
                img: "/dynamic_tele/static/src/img/kanban_png.png",
                icon: "fa fa-th-large"
            };
            this.views.search = {
                label: "Search",
            ...
            this.views.form = {
                ...
                name: "form",
                description: "A way to view your board with cards and lists in a pipeline",
                img: "/dynamic_tele/static/src/img/form_png.png",
            ...
            this.views.calendar = {
                ...
                img: "/dynamic_tele/static/src/img/calendar_png.png",
            ...
            this.views.plan = {
                ...
                img: "/dynamic_tele/static/src/img/plan_png.png",
                icon: "fa fa-tasks"
            };
            this.views.text = {
                label: "Text",
                ...
                img: "/dynamic_tele/static/src/img/text_png.png",
                icon: ""
            };
            this.views.list = {
                label: "Table",
                ...
                img: "/dynamic_tele/static/src/img/list_png.png",
                icon: "fa fa-list-ul"
            };
            this.views.overview = {
                label: "Overview",
                ...
                img: "/dynamic_tele/static/src/img/overview_png.png",
                icon: ""
            };
            this.views.countdown = {
                ...
                img: "/dynamic_tele/static/src/img/countdown_png.png",
                icon: ""
            };
            this.views.quote = {
                ...
                img: "/dynamic_tele/static/src/img/quote_png.png",
                icon: ""
            };
            this.views.embed_everything = {
                ...
                img: "/dynamic_tele/static/src/img/embed_everything_png.png",
                icon: ""
            };
            this.views.youtube = {
                label: "Youtube",
                ...
                img: "/dynamic_tele/static/src/img/youtube_png.png",
                icon: ""
            };
            this.views.bookmark = {
                label: "Bookmarks",
                ...
                img: "/dynamic_tele/static/src/img/bookmarks_png.png",
                icon: ""
            };
            this.views.playlist = {
                label: "Playlist",
                ...
                img: "/dynamic_tele/static/src/img/playlist_png.png",
                icon: ""
            };
        ...
        onClose: async function (e) {
            ...
            tele['studio'].env.bus.trigger("CLEAR-CACHES");
