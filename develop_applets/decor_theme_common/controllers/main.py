...
class WebsiteCategoyTele(http.Controller):
    ...
    def product_category_data(self, page=1, category_id=None, search='', **post):
        ...
        if not categories and category_id:
            ...
            return request.render('decor_theme_common.website_sale_categoy_list_tele', {
    ...
    def product_brand_data(self, page=1, brand_id=None, search='', **post):
        ...
        if not brands and brand_id:
            ...
            return request.render('decor_theme_common.website_sale_brand_list_tele', {
                'brands': brands,
                'pager': pager,
                'search': search
            })
...
class TeleWebsiteSale(WebsiteSale):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, brands=None, **post):
        if request.env['website'].sudo().get_current_website().theme_id.name == 'theme_decor':
            ...
            result = super(TeleWebsiteSale, self).shop(
            ...
            return super(TeleWebsiteSale, self).shop(page=page, category=category, search=search, ppg=ppg, **post)
