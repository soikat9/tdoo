...
SOLID_COLOR_2 = '#f5f5f5'
SOLID_COLOR_3 = '#f5f5fa'
SOLID_BUTTON_COLOR_1 = '#07a650'
SOLID_BUTTON_COLOR_2 = '#f5f5f5'
...
import base64
URL = '/tele_backend_theme/static/src/scss/tele_theme_variables.scss'
class TeleThemeSettings(models.Model):
    """
    ...
    font_style = fields.Selection([
        ...
        ("rubik",'Rubik'), 
        ("lora",'Lora'),        
        ],string="Font Style", default="inter")   
    ...
    tele_sticky_tree_view = fields.Boolean(string="Sticky Tree View")
    ...
    def action_apply_theme_settings(self):
        ...
        if self:
            content = """
            $tele_theme_color_type:%(tele_theme_color_type)s;
            $tele_theme_primary_1_color:%(tele_theme_primary_1_color)s;
            $tele_theme_primary_2_color:%(tele_theme_primary_2_color)s; 
            $tele_theme_secondary_color:%(tele_theme_secondary_color)s;                                  
            $tele_theme_background_type:%(tele_theme_background_type)s;              
            $tele_button_type:%(tele_button_type)s; 
            $tele_button_primary_1_color:%(tele_button_primary_1_color)s; 
            $tele_button_primary_2_color:%(tele_button_primary_2_color)s; 
            $tele_button_secondary_color:%(tele_button_secondary_color)s;   
            $tele_sidebr_type:%(tele_sidebr_type)s;
            $tele_sidebar_position:%(tele_sidebar_position)s;
            $tele_font_style:%(tele_font_style)s;
            $tele_checkbox_style:%(tele_checkbox_style)s;
            $tele_radion_btn_style:%(tele_radion_btn_style)s;
            $tele_theme_loading_type:%(tele_theme_loading_type)s;
            $tele_theme_scrollbar_style:%(tele_theme_scrollbar_style)s;
            $tele_theme_tab_style:%(tele_theme_tab_style)s;
            $tele_theme_form_style:%(tele_theme_form_style)s;

            
            $tele_theme_sticky_tree_view:%(tele_theme_sticky_tree_view)s;
            $tele_theme_one2many_field_tree_view:%(tele_theme_one2many_field_tree_view)s;
            $tele_theme_sticky_form_view_chatter:%(tele_theme_sticky_form_view_chatter)s;
            $tele_theme_sticky_form_view_statusbar:%(tele_theme_sticky_form_view_statusbar)s;
            
            $tele_theme_separator_style:%(tele_theme_separator_style)s;
            $tele_theme_popup_style:%(tele_theme_popup_style)s;
            $tele_theme_font_size:%(tele_theme_font_size)s;
            
            """ % {
            'tele_theme_color_type':self.theme_color_type,
            'tele_theme_primary_1_color':self.theme_primary_1_color,  
            'tele_theme_primary_2_color':self.theme_primary_2_color,
            'tele_theme_secondary_color':self.theme_secondary_color,                                              
            'tele_theme_background_type':self.theme_background_type, 
            # 'tele_theme_background_color':self.theme_background_color, 
            'tele_button_type':self.button_type, 
            # 'tele_button_color_type':self.button_color_type, 
            'tele_button_primary_1_color':self.button_primary_1_color, 
            'tele_button_primary_2_color':self.button_primary_2_color, 
            'tele_button_secondary_color':self.button_secondary_color,                                     
            # 'tele_is_use_google_font':self.is_use_google_font, 
            # 'tele_google_font_family':self.google_font_family,
            'tele_sidebr_type':self.sidebar_style,
            'tele_sidebar_position':self.sidebar_position,
            'tele_font_style':self.font_style,
            'tele_checkbox_style':self.checkbox_style,
            'tele_radion_btn_style':self.radio_btn_style,
            'tele_theme_loading_type':self.theme_loading_type,
            'tele_theme_scrollbar_style':self.theme_scrollbar_style,
            'tele_theme_tab_style':self.theme_tab_style,
            'tele_theme_form_style':self.theme_form_style,

            'tele_theme_sticky_tree_view':self.tele_sticky_tree_view,
            'tele_theme_one2many_field_tree_view':self.tele_one2many_field_tree_view,
            'tele_theme_sticky_form_view_chatter':self.tele_sticky_form_view_chatter,
            'tele_theme_sticky_form_view_statusbar':self.tele_sticky_form_view_statusbar,
            # 'tele_theme_sticky_pivot_view':self.tele_sticky_pivot_view,
            'tele_theme_separator_style':self.theme_separator_style,
            'tele_theme_popup_style':self.theme_popup_style,
            'tele_theme_font_size':self.theme_font_size,
            }
            ...
            if custom_attachment.sudo():
                ...
                new_attach = {
                    'name': 'tele_theme_variables.scss',
                    'type': "binary",
                    'mimetype': 'text/scss',
                    'datas': datas,
                    'url': URL,
