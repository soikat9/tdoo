tele.define("tele_backend_theme", function (require) {
    "use strict";
    ...
    // https://github.com/Faisal-Manzer/postcss-viewpotele-height-correction
    ...
    FormRenderer.include({
        ...
        _renderHeaderButtons: function () {
            ...
            const $dropdown = $(
                core.qweb.render("tele_backend_theme.MenuStatusbarButtons")
            );
