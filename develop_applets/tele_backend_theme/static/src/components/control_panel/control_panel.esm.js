...
import {deviceContext} from "@tele_backend_theme/components/ui_context.esm";
...
patch(LegacyControlPanel.prototype, "tele_backend_theme.LegacyControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
...
patch(ControlPanel.prototype, "tele_backend_theme.ControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
            mobileSearchMode: "",
...
patch(SearchBar, "tele_backend_theme.SearchBarMobile", {
    template: "tele_backend_theme.SearchBar",
});
