tele.define('tele_dashboard_workspace_list.tele_dashboard_kpi_preview', function(require) {
    "use strict";
...
//            });
            this.tele_kpi_preview_background_style($kpi_preview, tele_rgba_background_color, tele_rgba_font_color);
            this.$el.append($kpi_preview);
        },

        tele_kpi_preview_background_style: function($kpi_preview, tele_rgba_background_color, tele_rgba_font_color){
            $kpi_preview.css({
                "background-color": tele_rgba_background_color,
                "color": tele_rgba_font_color,
            });
