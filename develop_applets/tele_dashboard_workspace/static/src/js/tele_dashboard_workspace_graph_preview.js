tele.define('tele_dashboard_workspace_list.tele_dashboard_graph_preview', function(require) {
    "use strict";
    ...
    var TeleGraphPreview = AbstractField.extend({
        ...
        tele_chart_color_pallet: function(gradient, setsCount, palette){
            var chartColors = [];
        ...
        teleChartColors: function(palette, teleMyChart, teleChartType, teleChartFamily, tele_show_data_value) {
            ...
            //Calculate colors
            var chartColors = this.tele_chart_color_pallet(gradient, setsCount, palette);
            var datasets = teleMyChart.config.data.datasets;
