...
class TeleDashboardWorkspaceTemplate(models.Model):
    _name = 'tele_dashboard_workspace.board_defined_filters'
    _description = 'Dashboard Workspace Defined Filters'

    name = fields.Char("Filter Label")
    tele_dashboard_board_id = fields.Many2one('tele_dashboard_workspace.board', string="Dashboard")
...
class TeleDashboardWorkspaceTemplate(models.Model):
    _name = 'tele_dashboard_workspace.board_custom_filters'
    _description = 'Dashboard Workspace Custom Filters'
