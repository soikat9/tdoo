tele.define('theme_decor.bizcommon_frontend_js', function(require) {
    ...
    animation.registry.product_configurator_dynamic_product = animation.Class.extend({
        selector: ".tele_product_configurator",
        disabledInEditableMode: false,
        start: function() {
            var self = this.$target;
            if (this.editableMode) {
    ...
    animation.registry.category_configurator_dynamic_category = animation.Class.extend({
        selector: ".tele_category_configurator",
        disabledInEditableMode: false,
        start: function() {
            var self = this.$target;
            if (this.editableMode) {
    ...
    animation.registry.brand_configurator_dynamic_brand = animation.Class.extend({
        selector: ".tele_brand_configurator",
        disabledInEditableMode: false,
        start: function() {
            var self = this.$target;
            if (this.editableMode) {
    ...
    animation.registry.s_tele_theme_blog_slider_snippet = animation.Class.extend({
