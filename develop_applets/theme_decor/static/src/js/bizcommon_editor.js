tele.define('theme_decor.bizcommon_editor_js', function(require) {
    ...
    ajax.loadXML('/theme_decor/static/src/xml/tele_theme_common.xml', qweb);
            ...
            function startinterval() {
                ...
                function clicksavebtn() {
                    $('.o_legacy_dialog .modal-footer > button.btn-primary').on('click', function() {
                        $('.tele_product_configurator').find('[class*=container]').empty();
                        $('.tele_brand_configurator').find('[class*=container]').empty();
                        $('.tele_category_configurator').find('[class*=container]').empty();
                    })
                }
            }
        },
    ...
    options.registry.s_tele_theme_multi_product_tab_snippet = options.Class.extend({
    ...
    options.registry.s_tele_theme_blog_slider_snippet = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
