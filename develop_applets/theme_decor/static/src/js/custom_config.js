	...
	publicWidget.registry.headerrelatedjs = publicWidget.Widget.extend({
		...
		start: function () {
					...
					/*show bottom bar start*/
			      	$('#wrapwrap').scroll(function() {
				        if ($(this).scrollTop() > 100) {
				          $('.tele-mbl-bottom-bar').addClass('show-bottom-bar');
				        } else {
				          $('.tele-mbl-bottom-bar').removeClass('show-bottom-bar');
				        }
			      	});
					/*show bottom bar start*/
		    ...
		    if (size <= 1400 && size > 992){
			    $(function(){
				  	var to_toggle = $(".header-search-btn .tele-search");
			...
			/* menu sidebar js for ipad and mbl */
		  	...
		  	$(document).on("click", function(e) {
			    ...
			    if (!$(e.target).closest('.tele-search-results').length) {
			      	$(".tele-search-results").hide("dropdown-menu");
			    }
			    if (!$(e.target).closest('.tele-search-text').length) {
			      	$(".tele-search-text").hide("dropdown-menu");
			    }
		  	});
