tele.define('tele_theme_setting.theme_editor', function (require) {
    "use strict";

    var Widget = require('web.Widget');
    var Customizer = require('tele_theme_setting.customizer')

    var TeleThemeEditor = Customizer.extend({

        template: 'tele_theme_setting.customizer_panel',
        items: [],
