tele.define('tele_theme_setting.customizer', function (require) {
    ...
    var theme_setting = require('tele_theme_setting.theme_setting')
    var framework = require('web.framework');
    var Dialog = require('web.Dialog');

    var TeleCustomizer = Widget.extend({

        template: 'tele_theme_setting.customizer',
        sequence: 0,
        items: [],
        $panel: undefined,
        ...
        get_modes_data: function () {
            ...
            if (!this.user_setting.theme_modes || this.user_setting.theme_modes.length == 0) {
                this._rpc({
                    "model": "tele_theme_setting.setting_manager",
        ...
        _init_customizer: function () {
            if (!this.$panel) {
                this.$panel = $(core.qweb.render('tele_theme_setting.customizer_panel', {
                    "widget": this
                }));
        ...
        _update_cur_style: function () {
            ...
            $('body').removeClass('preview')
            $('body').removeClass('tele_creating_mode')
        ...
        _on_delete_theme_style: function (event) {
            ...
            this._rpc({
                "model": "tele_theme_setting.theme_style",
                "method": "delete_style",
                "args": [style_id]
            }).then(function () {
        ...
        _update_preview_mode_css: function () {
            ...
            return this._rpc({
                "model": "tele_theme_setting.theme_mode",
                "method": "get_mode_preview_data",
                "args": [mode_id, style_id]
            }).then(function (mode_style_txt) {
                var style = document.getElementById("tele_preview_mode_style_id");
                if (style.styleSheet) {
        ...
        _add_new_style_nav_item: function (theme_style) {
            ...
            var $nav_item = $(core.qweb.render('tele_theme_setting.theme_style_tab', { theme_style: theme_style }))
        ...
        _add_new_style_tab_pane: function (theme_style) {
            var mode_id = this._get_cur_model_id();
            var $theme_mode_container = this.$('.theme-mode-container[data-mode-id=' + mode_id + ']');
            var $tab_pane = $(core.qweb.render('tele_theme_setting.theme_style_tab_pane', { theme_style: theme_style }));
        ...
        _clear_preview_data: function () {
            ...
            var style = document.getElementById('tele_theme_setting_preview_mode_style_id');
            if (style.styleSheet) {
                style.setAttribute('type', 'text/css');
                style.styleSheet.cssText = '';
            }
            // clear the style data
            style = document.getElementById('tele_theme_setting_preview_style_id');
            if (style.styleSheet) {
                style.setAttribute('type', 'text/css');
                style.styleSheet.cssText = '';
            }
        ...
        _update_style: function (preview) {
            ...
            this._rpc({
                ...
                var style = undefined;
                if (preview) {
                    style = document.getElementById('tele_preview_style_id');
                } else {
                    style = document.getElementById('tele_style_id');
                }
                if (style.styleSheet) {
                    style.setAttribute('type', 'text/css');
        ...
        _export_style: function (event) {
            ...
            this.getSession().get_file({
                ...
                url: '/tele_theme_setting/export_theme_style/' + styleId,
            });
        },
        ...
        _udpate_style_tab: function (theme_style) {
            ...
            var $tab_item = $(core.qweb.render('tele_theme_setting.theme_style_tab', { theme_style: theme_style }))
        ...
        _add_style_item: function (event) {
            ...
            this.do_action({
                ...
                view_type: 'form',
                view_mode: 'form',
                res_model: "tele_theme_setting.style_item",
                target: 'new',
                context: {
                ...
                on_close: function (res) {
                    ...
                    self._rpc({
                        "model": "tele_theme_setting.style_item",
                        ...
                        var $new_style_item = $(core.qweb.render("tele_theme_setting.style_item", {
        ...
        _add_item_group: function (event) {
            ...
            this.do_action({
                ...
                view_type: 'form',
                view_mode: 'form',
                res_model: "tele_theme_setting.style_item_group",
                target: 'new',
                context: {
        ...
        _update_item_ui: function (style_item) {
            ...
            var $new_item = $(core.qweb.render('tele_theme_setting.style_item', { style_item: style_item }))
        ...
        _edit_style: function (event) {
            ...
            self.do_action({
                type: 'ir.actions.act_window',
                res_model: 'tele_theme_setting.theme_style',
                res_id: style_id,
                views: [[false, 'form']],
                context: {
                    'form_view_ref': 'tele_theme_setting.theme_style_edit_form',
                },
                target: 'new',
            }, {
                on_close: function (res) {
        ...
        _toggle_sub_group_panel: function (style_id, group_id, sub_group_id, force_visible) {
            ...
            if ($panel.length == 0) {
                ...
                if (group) {
                    ...
                    if (sub_group) {
                        $panel = $(core.qweb.render('tele_theme_setting.sub_group_body', { sub_group: sub_group }))
        ...
        _on_add_new_group: function (event) {
            ...
            this._rpc({
                "model": "tele_theme_setting.style_item_group",
                ...
                self.do_action(action, {
                    on_close: function (res) {
                        ...
                        self._rpc({
                            ...
                            var $new_group = $(core.qweb.render('tele_theme_setting.style_item_group', {
                                'group': group_data[0],
        ...
        _on_edit_item_var: function (event) {
            ...
            this._rpc({
                "model": "tele_theme_setting.theme_var",
        ...
        _reload_style_item: function (style_item_id) {
            // get style item data
            self._rpc({
                "model": "tele_theme_setting.style_item_var",
                "method": "get_var_data",
                "args": [style_item_id]
                ...
                // update the var ui
                var $var = $(core.qweb.render("tele_theme_setting.style_item_var", {
            ...
            this._rpc({
                ...
                self.do_action(action, {
                    on_close: function (res) {
                        ...
                        // get sub group data
                        self._rpc({
                            "model": "tele_theme_setting.style_item_sub_group",
                            ...
                            var $new_sub_group = $(core.qweb.render('tele_theme_setting.sub_group', {
        ...
        _add_new_theme_mode_ui: function (mode) {
            var $tab_item = $(core.qweb.render('tele_theme_setting.theme_mode_tab_item', {
                theme_modes: [mode]
            }))
            this.$('.theme_mode_name_container').append($tab_item)
            var $tab_pane = $(core.qweb.render('tele_theme_setting.theme_mode', {
                theme_mode: mode
            }))
        ...
        _on_import_style: function (event) {
            ...
            this.do_action({
                ...
                view_type: 'form',
                view_mode: 'form',
                res_model: "tele_theme_setting.import_theme_style",
                target: 'new',
                views: [[false, 'form']],
            }, {
                on_close: function (res) {
        ...
        _update_mode_style_css: function (styleText) {
            var $body = $('body')
            var style_id = 'tele_mode_style_id';
        ...
        _on_set_bk_image: function (event) {
            ...
            this.do_action({
                type: 'ir.actions.act_window',
                res_model: 'tele_theme_setting.background_image_wizard',
                view_type: 'form',
                view_mode: 'form',
                target: 'new',
                views: [[false, 'form']],
