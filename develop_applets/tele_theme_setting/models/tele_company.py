...
from tele import fields, models, exceptions
import base64
from datetime import date, datetime
from tele.modules.module import get_resource_path


class TeleCompany(models.Model):
    '''
    ...
    def _get_default_favicon_icon(self):
        ...
        tmp_path = get_resource_path(
            'tele_theme_setting', 'static', 'images', 'favicon.png')
    ...
    def _get_default_small_logo(self):
        ...
        '''
        tmp_path = get_resource_path(
            'tele_theme_setting', 'static', 'images', 'favicon.ico')
        return base64.b64encode(open(tmp_path, 'rb').read())
    ...
    def get_mode_data(self):
        ...
        self.env["tele_theme_setting.theme_mode"].check_default_mode_data(owner)
        return self.env["tele_theme_setting.theme_mode"].get_mode_data()
    ...
    def check_setting_id(self):
        ...
        # get fields of tele_theme_setting.setting_base
        ...
        if not self.setting_id:
            tmp_record = self.env["tele_theme_setting.setting_base"].create(values)
    ...
    def edit_company_theme(self):
        ...
        rst = {'settings': theme_settings, 'cur_mode_id': cur_mode_id, 'cur_style_id': cur_style_id, 'cur_mode_name': cur_mode_name, 'is_admin': self.env.is_admin(), 'owner': owner}
    ...
    def theme_setting(self):
        ...
        return {
            ...
            "target": "new",
            "views": [[self.env.ref(
                'tele_theme_setting.tele_edit_company_setting').id, "form"]]
        }
