...
class TeleHome(tele.applets.web.controllers.main.Home):
    ...
    @http.route('/tele_theme_setting/export_theme_style/<int:style_id>', type='http', auth="user")
    def export_theme_style(self, style_id):
        ...
        :return:
        '''
        theme_style = request.env["tele_theme_setting.theme_style"].sudo().browse(style_id)
    ...
    def company_small_logo(self, dbname=None, **kw):
        ...
        _get_default_image = functools.partial(
            get_resource_path, 'tele_theme_setting', 'static', 'images')
        uid = None
    ...
    @http.route('/tele_theme_setting/favicon', type='http', auth="none")
    def favicon(self):
        ...
        if not favicon:
            tmp_path = get_resource_path('tele_theme_setting', 'static', 'images', 'favicon.ico')
