...
from tele.applets.component.exception import NoComponentError, SeveralComponentError
...
class TestComponent(TransactionComponentRegistryCase):
    ...
    We test the chain tele Model -> generate a WorkContext instance -> Work
    with Component.

    Tests are inside Tele transactions, so we can work
    with Tele's env / models.
    """
