...
class AnitaHome(tele.applets.web.controllers.main.Home):
    '''
    ...
    def web_login(self, redirect=None, **kw):
        ...
        login_style = ir_config.get_param(
            key='anita_login.login_style', default='login_style1')
        login_template = 'anita_login.{login_style}'.format(login_style=login_style)
        
        # add extra info to login page
        values['title'] = ir_config.get_param(
            "anita_theme_setting.window_default_title", "Anita Tele")
        values['powered_by'] = ir_config.get_param("powered_by", "Anita Tele")
