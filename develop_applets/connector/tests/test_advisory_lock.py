...
from tele.applets.component.core import WorkContext
from tele.applets.component.tests.common import TransactionComponentCase
from tele.applets.connector.database import pg_try_advisory_lock
...
class TestAdvisoryLock(TransactionComponentCase):
    ...
    def test_concurrent_import_lock(self):
        ...
        # instanciate another component using a different tele env
