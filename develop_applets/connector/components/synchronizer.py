...
class Synchronizer(AbstractComponent):
    ...
    def mapper(self):
        ...
        :rtype: :py:class:`tele.applets.component.core.Component`
        """
...
class Exporter(AbstractComponent):
    """Synchronizer for exporting data from Tele to a backend"""
...
class GenericExporter(AbstractComponent):
    """Generic Synchronizer for exporting data from Tele to a backend"""
    ...
    def run(self, binding, *args, **kwargs):
        ...
        # record
        if not tele.tools.config["test_enable"]:
    ...
    def _retry_unique_violation(self):
        ...
        record created by :meth:`_export_dependency`), resulting in:
            ...
            constraint "my_backend_product_product_tele_uniq"
            DETAIL:  Key (backend_id, tele_id)=(1, 4851) already exists.
    ...
    def _export_dependency(
        ...
        .. warning:: a commit is done at the end of the export of each
                     ...
                     So you *must* take care not to modify the Tele
        ...
        :type relation: :py:class:`tele.models.BaseModel`
        ...
        if wrap and hasattr(relation, binding_field):
            ...
            # depends.
                ...
                # tele_id) should exist on the binding model
    ...
    def _map_data(self):
        ...
        :py:class:`~tele.applets.connector.components.mapper.MapRecord`
...
class Importer(AbstractComponent):
    """Synchronizer for importing data from a backend to Tele"""
