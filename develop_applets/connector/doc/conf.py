...
MANIFEST_FILES = ["__manifest__.py", "__tele__.py", "__tele__.py"]


def is_module(path):
    """return False if the path doesn't contain an tele module, and the full
...
def is_installable_module(path):
    """return False if the path doesn't contain an installable tele module,
...
if os.environ.get("TRAVIS_BUILD_DIR") and os.environ.get("VERSION"):
    ...
    tele_folder = "tele-" + os.environ.get("VERSION")
    tele_root = os.path.join(repos_home, tele_folder)
    build_path = os.environ["TRAVIS_BUILD_DIR"]
else:
    # build from dev
    tele_root = os.path.abspath("../../../../src")
...
def add_path(*paths):
    applets_paths.append(os.path.join(*paths))


add_path(tele_root, "tele", "applets")
add_path(tele_root, "applets")
add_path(build_path)
...
# sphinxtele.ext.autodoc variables
sphinxtele_root_path = tele_root
sphinxtele_applets = applets
sphinxtele_applets_path = applets_paths
...
intersphinx_mapping = {
    ...
    "teleweb": ("https://www.tele.com/documentation/10.0/", None),
    "teledev": ("https://www.tele.com/documentation/10.0/", None),
    "connectormagento": ("http://www.tele-magento-connector.com", None),
}
