...
.. automodule:: tele.applets.queue_job.jobrunner.runner


What is a channel?
------------------

.. autoclass:: tele.applets.queue_job.jobrunner.channels.Channel
   :noindex:

How to configure Channels?
--------------------------

The ``TELE_QUEUE_JOB_CHANNELS`` environment variable must be
set before starting Tele in order to enable the job runner
...
Example ``TELE_QUEUE_JOB_CHANNELS``:
