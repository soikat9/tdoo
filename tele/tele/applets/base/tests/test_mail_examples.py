...
<a href="http://localhost:9000#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH">http://localhost:9000#action=login&amp;db=mail_1&amp;token=rHdWcUART5PhEnJRaXjH</a></p>
      </div>
    </blockquote>
...
<div><p>Log in our portal at: <a href="http://localhost:9000#action=login&amp;db=mail_1&amp;login=demo">http://localhost:9000#action=login&amp;db=mail_1&amp;login=demo</a></p></div>
