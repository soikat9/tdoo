...
class PwaMain(http.Controller):
    ...
    def service_worker(self):
        ...
        content = qweb._render('tele_theme_backend_ent.service_worker', {
    ...
    def pwa_offline(self, **kw):
        return request.render('tele_theme_backend_ent.pwa_offline_page',)

    @http.route('/tele_theme_backend_ent/<int:company_id>/manifest.json', type='http', auth="public", website=True)
