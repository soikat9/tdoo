...
class TestIncomingTransactionResponse(BaseCase):
    @patch.dict(
        "sys.modules", {
            ...
            "tele.applets.hw_drivers.iomt_handlers.interfaces.SocketInterface": MagicMock(),
        }
    )
    def setUp(self):
        # pylint: disable=import-outside-toplevel
        from tele.applets.iomt.iomt_handlers.drivers.IngenicoDriver import IncomingIngenicoMessage
    ...
    def test_parse_ticketdata(self):
        ...
        with file_open('iomt/tests/data/TransactionResponse', 'rb') as f:
            dev = MockSocket(f)
...
class TestOutgoingIngenicoMessage(BaseCase):
    ...
    def setUp(self):
        # pylint: disable=import-outside-toplevel
        from tele.applets.iomt.iomt_handlers.drivers.IngenicoDriver import OutgoingIngenicoMessage
