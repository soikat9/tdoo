...
PATH_ZIP_LIB=/home/pi/tele/applets/hw_drivers/iomt_handlers/lib/
PATH_LIB=${PATH_ZIP_LIB}ctep/lib/

curl -sS http://download.tele.studio/master/posbox/iomtbox/worldline-ctepv21_07.zip -o  "${PATH_ZIP_LIB}worldline-ctepv21_07.zip"
