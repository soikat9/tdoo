...
from tele.applets.hw_drivers.iomt_handlers.interfaces.SocketInterface import socket_devices
...
class IngenicoDriver(Driver):
    ...
    def disconnect(self):
        ...
        # update_iomt_devices method would not detect that something changed and no new
        ...
        # _detected_devices in Interface, so update_iomt_devices will create a new
