...
from tele import api, exceptions, models, _
from tele.osv.expression import AND, OR, normalize_domain
from tele.tools.safe_eval import const_eval
...
class IrAttachment(models.Model):
    ...
    def _register_hook(self):
        ...
        # tele/modules/loading.py
        load_modules_frame = calframe[1][0]
        # 'update_module' is an argument that 'load_modules' receives with a
        # True-ish value meaning that an install or upgrade of applet has been
        # done during the initialization. We need to move the attachments that
        # could have been created or updated in other applets before this applet
        # was loaded
        ...
        # when we are upgrading applets, some of them might add attachments.
        ...
        # ir.attachment at every upgrade of the applets
        if update_module:
    ...
    def do_in_new_env(self, new_cr=False):
        ...
        Using a new Tele Environment thus a new PG transaction.
        """
    ...
    def _force_storage_to_object_storage(self, new_cr=False):
        ...
        # contain 'res_field'.
        # https://github.com/tele/tele/blob/9032617120138848c63b3cfa5d1913c5e5ad76db/tele/applets/base/ir/ir_attachment.py#L344-L347
