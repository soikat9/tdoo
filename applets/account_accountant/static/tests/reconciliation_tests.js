...
QUnit.module('account', {
    ...
    QUnit.test('Reconciliation with rounding different representation (but same value) is not partial', async function (assert) {
        ...
        this.params.move_lines_for_manual_reconciliation = {
            '[283,null,"",0]': [
                { id: 26,
                        name: "INV/2021/08/0001", ref: "", date: "08/25/2021", date_maturity: "08/25/2021", account_id: [ 6, "121000 Account Receivable" ], account_code: "121000", account_name: "Account Receivable", account_type: "receivable", journal_id: [ 1, "Customer Invoices" ], partner_id: 10, partner_name: "Tele Network", is_liquidity_line: false, currency_id: 3, debit: 365125, credit: 0, amount_str: "$ 365,125.00", amount_currency: 0, amount_currency_str: "", total_amount_currency_str: "", total_amount_str: "$ 365,125.00", recs_count: 3 },
                { id: 20, name: "INV/2021/09/0002", ref: "", date: "09/08/2021", date_maturity: "10/08/2021", account_id: [ 6, "121000 Account Receivable" ], account_code: "121000", account_name: "Account Receivable", account_type: "receivable", journal_id: [ 1, "Customer Invoices" ], partner_id: 10, partner_name: "Tele Network", is_liquidity_line: false, currency_id: 3, debit: 169625, credit: 0, amount_str: "$ 169,625.00", amount_currency: 0, amount_currency_str: "", total_amount_currency_str: "", total_amount_str: "$ 169,625.00", recs_count: 3 },
                { id: 23, name: "INV/2021/09/0003", ref: "", date: "09/08/2021", date_maturity: "10/08/2021", account_id: [ 6, "121000 Account Receivable" ], account_code: "121000", account_name: "Account Receivable", account_type: "receivable", journal_id: [ 1, "Customer Invoices" ], partner_id: 10, partner_name: "Tele Network", is_liquidity_line: false, currency_id: 3, debit: 143750, credit: 0, amount_str: "$ 143,750.00", amount_currency: 0, amount_currency_str: "", total_amount_currency_str: "", total_amount_str: "$ 143,750.00", recs_count: 3 }
              ],
        };
        ...
        assert.strictEqual(widget.$('.accounting_view div[name="partner_id"] input').val(), "Tele Network", "Display the partner in input");
