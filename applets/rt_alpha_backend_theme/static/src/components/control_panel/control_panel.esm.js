...
import {deviceContext} from "@rt_alpha_backend_theme/components/ui_context.esm";
...
patch(LegacyControlPanel.prototype, "rt_alpha_backend_theme.LegacyControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
...
patch(ControlPanel.prototype, "rt_alpha_backend_theme.ControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
            mobileSearchMode: "",
...
patch(SearchBar, "rt_alpha_backend_theme.SearchBarMobile", {
    template: "rt_alpha_backend_theme.SearchBar",
});
