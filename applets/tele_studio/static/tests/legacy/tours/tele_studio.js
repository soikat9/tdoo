...
tour.register('tele_studio_new_report_tour', {
    ...
    //extra_trigger: '.o_tele_studio_report_editor iframe span[t-field="table_line.display_name"]:not(:contains(My Company, Administrator))', // the id has been updated in the iframe
}, {
