...
var ImageWidget = FileWidget.extend({
    ...
    _clear: function (type) {
        ...
        var allImgClasses = /(^|\s+)(img|img-\S*|o_we_custom_image|rounded-square|rounded|thumbnail|shadow|w-25|w-50|w-75|w-100|o_modified_image_to_save)(?=\s|$)/g;
...
var IconWidget = SearchableMediaWidget.extend({
     ...
     */
    _clear: function () {
        var allFaClasses = /(^|\s)(fa|(text-|bg-|fa-)\S*|rounded-square|rounded|thumbnail|img-thumbnail|shadow)(?=\s|$)/g;
