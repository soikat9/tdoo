...
class TestHrReferral(TestHrReferralBase):
    ...
    def test_referral_add_points(self):
        with self.assertRaises(UserError):
            self.contract_promotion.sudo().buy()
        job_applicant = self.env['hr.applicant'].create({
            'name': 'Technical worker',
        ...
        self.assertEqual(shopped_item.points, -self.contract_promotion.cost, "The item bought decrease the number of points.")
    ...
    def test_referral_multi_company(self):
        ...
        self.assertEqual(self.red_contract_promotion.points_missing, self.red_contract_promotion.cost, "10 points are missing")
