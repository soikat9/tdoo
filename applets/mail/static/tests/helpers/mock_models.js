        ...
        return {
            ...
            'mail.message': {
                fields: {
                    ...
                    starred_partner_ids: { string: "Favored By", type: 'many2many', relation: 'res.partner' },
            ...
            'mail.notification': {
                fields: {
                    ...
                    res_partner_id: { string: "Need action Recipient", type: 'many2one', relation: 'res.partner' },
                },
                records: [],
            },
            'mail.shortcode': {
